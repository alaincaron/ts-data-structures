...
describe('AvlTreeMultiSet', () => {
  describe('constructor', () => {
    ...
    it('should have specified capacity as unique argument', () => {
      const set = new AvlTreeMultiSet(2);
  ...
  describe('add', () => {
    ...
    it('should throw if full', () => {
      const set = new AvlTreeMultiSet(1);
      expect(set.add(1)).to.be.true;
      expect(set.isFull()).to.be.true;
  ...
  describe('offerFully', () => {
    ...
    it('should accept all items if enough capacity remaining', () => {
      const set = new AvlTreeMultiSet(6);
  ...
  describe('offerPartially', () => {
    ...
    it('should accept all the items if there is enough capacity remaining for distinct elements', () => {
      ...
      const set = new AvlTreeMultiSet(data.length);
  ...
  describe('forEach', () => {
    it('should execute for each item', () => {
      const data = [1, 2, 3];
      const set = AvlTreeMultiSet.create({ initial: data });
      const x: number[] = [];
  ...
  describe('fold', () => {
    ...
    it('should return initial value if empty', () => {
      const set = new AvlTreeMultiSet<number>();
      const sum = set.fold((a, b) => a + b, 1);
      expect(sum).equal(1);
    });
  });
  ...
  describe('setCount', () => {
    ...
    it('should throw if not enough remaining capacity for new count', () => {
      const ms = AvlTreeMultiSet.create(5);
  ...
  describe('firstEntry/firstKey/lasEntry/lastKey', () => {
    ...
    it('should return first entry', () => {
      const ms = AvlTreeMultiSet.create({ initial: ['foo', 'bar', 'foo', 'bar', 'bar'] });
    ...
    it('should respect the passed comparator', () => {
      const ms = AvlTreeMultiSet.create({
