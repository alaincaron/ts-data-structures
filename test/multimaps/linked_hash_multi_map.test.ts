...
import { ArrayList, LinkedHashMultiMap, OverflowException } from '../../src';
...
describe('LinkedHashMultiMap', () => {
  describe('constructor', () => {
    ...
    it('should have specified capacity as unique argument', () => {
      const map = new LinkedHashMultiMap(2);
    ...
    it('should use the specified capacity as per options', () => {
      const map = new LinkedHashMultiMap({ capacity: 2 });
      expect(map.capacity()).equal(2);
      expect(map.isEmpty()).to.be.true;
    });
  ...
  describe('put/get', () => {
    ...
    it('should throw if adding a new element and map is full', () => {
      const map = new LinkedHashMultiMap(1);
  ...
  describe('clear', () => {
    it('should clear the content', () => {
      const map = new LinkedHashMultiMap({ capacity: 3 });
      map.put('a', 1);
      map.put('b', 2);
