...
describe('AdapterMap', () => {
  describe('constructor', () => {
    ...
    it('should have specified capacity', () => {
      const map = AdapterMap.create({ capacity: 2 });
  ...
  describe('put/get', () => {
    ...
    it('should throw if adding a new element and map is full', () => {
      const map = AdapterMap.create({ capacity: 1 });
  ...
  describe('clear', () => {
    it('should clear the content', () => {
      const map = AdapterMap.create({ capacity: 3 });
      map.put('a', 1);
      map.put('b', 2);
  ...
  describe('filterKeys', () => {
    it('should remove keys not matching predicate', () => {
      const map = AdapterMap.create<string, number>();
      map.put('foo', 1);
      map.put('bar', 2);
      map.put('foobar', 3);
