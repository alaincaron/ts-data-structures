...
describe('LinkedMap', () => {
  describe('constructor', () => {
    ...
    it('should initialize with the provided Map', () => {
      const map = LinkedMap.create({ initial: new Map().set('a', 1).set('b', 2) });
    ...
    it('should initialize with the provided IMap', () => {
      const map1 = LinkedMap.create();
      map1.put('a', 1);
      map1.put('b', 2);
      const map = LinkedMap.create({ initial: map1 });
      expect(map.size()).equal(2);
      expect(map.get('a')).equal(1);
      expect(map.get('b')).equal(2);
    });
  ...
  describe('put/get', () => {
    ...
    it('should throw if adding a new element and map is full', () => {
      const map = LinkedMap.create({ capacity: 1 });
  ...
  describe('clear', () => {
    it('should clear the content', () => {
      const map = LinkedMap.create({ capacity: 3 });
      map.put('a', 1);
      map.put('b', 2);
  ...
  describe('filterKeys', () => {
    it('should remove keys not matching predicate', () => {
      const map = LinkedMap.create<string, number>();
      map.put('foo', 1);
      map.put('bar', 2);
      map.put('foobar', 3);
  ...
  describe('mapValues', () => {
    it('should create a new Map with a double of the values', () => {
      const m = new LinkedMap<string, number>();
      m.put('foo', 1);
      m.put('bar', 2);
      m.put('foobar', 3);
